...
response = WS.sendRequest(findTestObject('Reqres/Get All User Data'))

WS.sendRequestAndVerify(findTestObject('Reqres/Get All User Data'), FailureHandling.STOP_ON_FAILURE)

WS.verifyResponseStatusCode(response, 200)

WS.getElementPropertyValue(response, 'data.id')
...
WS.containsString(response, 'Janet', false)
